/**
 * @fileoverview Mathematical Content Rendering Service for NexPrepAI
...
export class MathRendererService {
  ...
  private processBulletPoints(text: string): string {
    ...
    return text.replace(bulletRegex, (match, bulletSection) => {      // Split into individual bullet points
